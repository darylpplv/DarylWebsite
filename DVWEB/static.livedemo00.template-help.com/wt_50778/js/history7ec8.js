...
(function(window) {
    ...
    function parseURL(href, isWindowLocation, isNotAPI) {
        ...
        if (href && !isWindowLocation) {
            ...
            href = /^(?:[\w0-9]+\:)?\/\//.test(href) ? href.indexOf("http://static.livedemo00.template-help.com/") === 0
                ? _protocol + href : href : _protocol + "//" + current._host + (
                href.indexOf("http://static.livedemo00.template-help.com/") === 0 ? href : href.indexOf("?") === 0
